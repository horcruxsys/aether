...
**Mission:** Making Aether "Agent-Native" via the Model Context Protocol.

This layer works directly alongside the `gateway-api` to govern agentic integration. It defines how autonomous agents (like Claude or GPT) interact with Aether as a "Native Tool," allowing for secure, grounded data exploration.
