 ...
 */
export async function billableInterceptor(request: FastifyRequest, reply: FastifyReply) {
  ...
  request.log.info(`[FINANCIAL] Debited Tenant ${tenantId} for ${tokenCost} credits based on query throughput.`);
}
