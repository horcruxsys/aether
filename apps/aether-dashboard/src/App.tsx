...
export default function App() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn(
        "WebSocket grid connection failed - Local environment boundary.",
      );
    }
  }, []);
    ...
    <div className="dashboard-container">
        ...
        <div className="log-viewer">
          {messages.length === 0 ? (
            <p className="empty-state">
              Awaiting OIDC Handshake & Stream Sync...
            </p>
          ) : (
      ...
      <div className="controls-group">
        <Button
          ...
          size="lg"
          onClick={() =>
            setAnomalyStatus("DRIFT DETECTED: LangGraph Overriding")
          }
        >
      ...
      <p
        className={`status-indicator ${anomalyStatus === "SYSTEM NOMINAL" ? "status-nominal" : "status-drift"}`}
      >
